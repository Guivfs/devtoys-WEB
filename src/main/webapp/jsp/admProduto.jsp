		...
		<div class="row">
			<ul class="nav nav-tabs centralizar">
				...
				<li class="nav-item"><a class="nav-link font active"
					href="admProduto.jsp">Administra��o de brinquedos</a></li>
				<li class="nav-item dropdown"><a
					class="nav-link font dropdown-toggle" data-bs-toggle="dropdown"
					href="#" role="button" aria-expanded="false">Cat�logo</a>
		...
		<table class="table table-hover">
			<thead>
				<tr class="table-group">
					...
					<th class="col" scope="pre�o">Pre�o</th>
					<th class="col" scope="categoria">Categoria</th>
					<th class="col" scope="desc">Descri��o</th>
					<th class="col" scope="img">Imagem</th>
					<th class="col" scope="acao">A��o</th>
				</tr>
			</thead>
